...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public void setupPathPlanner() {
    try {
      AutoBuilder.configure(
          ...
          (speeds, _forwards) -> setChassisSpeeds(speeds),
          new PPHolonomicDriveController( // HolonomicPathFollowerConfig, this should likely live in your Constants
                                          // class
  ...
  public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY,
    ...
    return run(() -> {
      // Make the robot move
      swerveDrive.drive(
          new Translation2d(Math.pow(translationX.getAsDouble(), 3) * swerveDrive.getMaximumChassisVelocity(),
