...
public class GyroHistory {
  ...
  public Rotation2d fetchInterpolatedGyroData(double wantedTimestamp) {
    ...
    // this will return the raw value if its on the edge, which should never happen,
    // but saftey
    ...
    // System.out.println("values nearby: " + prevValue + ", " + gyroData[bestID][0]
    // + ", " + nextValue);
    // System.out.println("times nearby: " + prevTimestamp + ", " +
    // gyroData[bestID][1] + ", " + nextTimestamp);
